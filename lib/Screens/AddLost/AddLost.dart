                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(context, MaterialPageRoute(
                      builder: (context) => Lost(category: _categories,title : title, description : description, country: _country, city : city,area: area,phone: phone)
                    ));
                  },
...
class Lost extends StatefulWidget {
  ...
  Lost({this.title,this.description,this.area,this.city,this.phone,this.country,this.category});
